...
class OrderConsumerTest {
    ...
    void consume_shouldCreateOrder() {
        Map<String, Object> msg = Map.of("activityId", 1L, "userId", 100L, "amount", "0.01", "timestamp", System.currentTimeMillis());
    ...
    void consume_shouldUpdateStockInDb() {
        Map<String, Object> msg = Map.of("activityId", 1L, "userId", 200L, "amount", "0.01", "timestamp", System.currentTimeMillis());
        orderConsumer.handleOrder(msg);
